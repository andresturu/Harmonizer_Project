...
Outputs 16-bit mono PCM at TARGET_SAMPLE_RATE, embedded as int16_t arrays.
"""
...
def convert_wav_to_raw(wav_path, raw_path):
    ...
    # ffmpeg -i C4.wav -ar 16000 -ac 1 -sample_fmt s16 -f s16le C4.raw
...
def main():
    ...
    header_lines.append(f"// Sample rate: {TARGET_SAMPLE_RATE} Hz, 16-bit mono PCM")
    ...
    header_lines.append("    const int16_t* samples;")
